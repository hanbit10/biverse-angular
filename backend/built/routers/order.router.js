    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, order_models_1.OrderModel.deleteOne({
                        user: req.user.id,
                        status: order_status_1.OrderStatus.NEW
                    })];
            case 1:
                _a.sent();
                newOrder = new order_models_1.OrderModel(__assign(__assign({}, requestOrder), { user: req.user.id }));
...
function getNewOrderForCurrentUser(req) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, order_models_1.OrderModel.findOne({
                        user: req.user.id,
                        status: order_status_1.OrderStatus.NEW
                    })];
